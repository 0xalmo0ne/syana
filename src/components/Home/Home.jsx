  ...
  return (
    <div className="font-sans">
      ...
      <section className="bg-blue-600 text-white py-32 px-6 text-center">
        <h1 className="text-5xl font-bold mb-4">أفضل خدمات صيانة الغسالات والتلاجات</h1>
...
<section className="bg-gray-50 py-20 px-6">
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-10">آراء عملاؤنا</h2>
          <Swiper
            ...
            {testimonials.map((client, index) => (
              <SwiperSlide key={index}>
                <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition h-full flex flex-col items-center">
                  <img src={client.image} alt={client.name} className="w-20 h-20 rounded-full mb-4 border-2 border-blue-400"/>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-blue-50 to-blue-100 text-center">
        ...
        <p className="text-gray-700 mb-4 text-lg">
          في <span className="font-semibold text-blue-600">[اسم شركتك]</span>، نحرص على أن تعمل أجهزتك المنزلية دائمًا بكفاءة. نحن متخصصون في <span className="font-semibold">صيانة الغسالات والتلاجات</span> بسرعة ومهنية.
        </p>
